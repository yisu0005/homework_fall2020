...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        pick_indices = np.random.permutation(self.obs.shape[0])[:batch_size]
        return (self.obs[pick_indices],
                self.acs[pick_indices],
                self.rews[pick_indices],
                self.next_obs[pick_indices],
                self.terminals[pick_indices])
